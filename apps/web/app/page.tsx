  ...
  return (
    <main className="site-shell">
      ...
      <section className="hero">
        <div className="hero-copy"><p className="eyebrow">Il calendario che ti porta fuori casa</p><h1>Questo weekend,<br /><em>succede qualcosa.</em></h1><p className="hero-text">Sagre, feste di paese, mostre e piccoli tesori da scoprire. Tutto quello che accade in Italia, vicino a te.</p><HeroSearch /></div>
